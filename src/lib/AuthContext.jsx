...
const getProfessionalRole = (metadata, profile) => {
  const metadataRoles = [
    metadata?.role,
  ...
  const professionalRole = allRoles.find((value) =>
    professionalRoles.includes(normalizeRole(value))
  );

  return professionalRole || null;
};
