...
export default function PsychologistCard({
  ...
  const hasInPerson = modalities.includes('in_person');
  ...
  const price =
    ...
    p.session_price !== undefined &&
    p.session_price !== ''
      ? Number(p.session_price)
      : null;
              ...
              {specializations
                ...
                .map((specialization, i) => (
                  <span
                    ...
                    className="text-[11px] px-2 py-0.5 rounded-full bg-violet-soft text-primary font-medium"
                  >
                    {specialization}
                  </span>
                ))}
