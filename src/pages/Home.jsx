...
const trustBadges = [
  {
    ...
    desc: "CRP e informações revisados pelo EntreNós",
  },
  {
    icon: Video,
    title: "Atendimento online e presencial",
    desc: "Escolha a modalidade que faz sentido para você",
  },
  {
    icon: CalendarCheck,
    title: "Agendamento simplificado",
    desc: "Veja horários disponíveis em tempo real",
  },
  {
    icon: Lock,
    title: "Privacidade em primeiro lugar",
    desc: "Seus dados protegidos, do primeiro acesso",
  },
];
...
const steps = [
  {
    ...
    desc: "Busque por especialidade, abordagem ou modalidade. Sem julgamento.",
  },
  {
    n: "02",
    title: "Agende no seu ritmo",
    desc: "Escolha data, horário e modalidade. Você no controle.",
  },
  {
    n: "03",
    title: "Converse com segurança",
    desc: "Entre em uma sala privada e segura, direto pela plataforma.",
  },
];
  ...
  useEffect(() => {
    ...
    const loadPsychologists = async () => {
      ...
      try {
        ...
        console.error("Erro inesperado ao carregar psicólogos:", error);
    ...
    <PageShell>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-24 lg:pt-28">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full glass text-xs font-medium text-primary animate-fade-up">
              <Sparkles size={14} />
              Cuidado psicológico com mais presença
            </div>

            <h1
              className="mt-6 text-4xl sm:text-5xl lg:text-6xl font-heading font-bold leading-[1.05] animate-fade-up"
            ...
            <p
              className="mt-6 text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed animate-fade-up"
              style={{ animationDelay: "160ms" }}
            >
              Você não precisa ter todas as respostas agora. Aqui seus dados
              estão seguros e você encontra profissionais de verdade, com CRP
              verificado.
            </p>
            ...
            >
              <Link
                to="/encontrar"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-full gradient-brand text-white font-semibold shadow-glow hover:scale-[1.02] transition-all duration-300"
              >
                Encontrar psicólogo
                <ArrowRight size={18} />
              </Link>
              ...
              <Link
                to="/triagem"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-full glass-strong font-semibold hover:bg-white transition-all duration-300"
              >
            ...
            <p
              className="mt-6 text-xs text-muted-foreground inline-flex items-center gap-1.5 animate-fade-up"
              style={{ animationDelay: "320ms" }}
            >
              <Lock size={12} />
              Plataforma segura · Conforme a LGPD · Sem gravação automática
            </p>
          </div>

          {/* PREVIEW DA VIDEOCHAMADA */}
          <div
              ...
              <div className="rounded-2xl overflow-hidden bg-gradient-to-br from-violet-soft/40 to-accent/10 aspect-[16/9] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="mt-5 font-heading font-semibold text-lg">
                      Sala de videochamada privada
                    </p>

                    <p className="text-sm text-muted-foreground mt-1">
                      "Esta é uma sala privada do EntreNós."
                    </p>
                  </div>
                </div>
                ...
                <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex items-center gap-2 px-2 py-2 rounded-full glass-strong">
                  ...
                  <span className="w-10 h-10 rounded-full bg-white/80 flex items-center justify-center text-xs">
                    🎤
                  </span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {trustBadges.map((badge, index) => {
            ...
            return (
              <div
                key={badge.title}
                className="card-elevated p-6 hover:shadow-glow transition-all duration-300 animate-fade-up"
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center max-w-2xl mx-auto mb-12">
          ...
          <p className="mt-4 text-muted-foreground">
            Três passos simples. Sem pressa, sem julgamento.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {steps.map((step, index) => (
            <div
              key={step.n}
              className="relative card-elevated p-7 animate-fade-up"
        ...
        <div className="rounded-3xl overflow-hidden glass-strong p-8 lg:p-12 relative">
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center relative">
            <div>
              ...
              <h2 className="mt-3 text-3xl sm:text-4xl font-heading font-bold">
                Uma sala privada, direto pela plataforma
              </h2>

              <p className="mt-4 text-muted-foreground leading-relaxed">
                Paciente e psicólogo entram em uma sala virtual segura sem sair
                do EntreNós. Câmera e microfone sob seu controle, chat privado
                durante a consulta e tela de espera até o profissional entrar.
              </p>
              ...
              <Link
                to="/videochamada"
                className="mt-8 inline-flex items-center gap-2 px-6 py-3 rounded-full gradient-brand text-white font-semibold shadow-soft hover:shadow-glow transition-all"
              >
                Ver como funciona
                <ArrowRight size={17} />
              </Link>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="flex items-end justify-between mb-8">
          <div>
            ...
            <h2 className="mt-3 text-3xl sm:text-4xl font-heading font-bold">
              Pessoas reais, prontas para conversar
            </h2>
          </div>
        ...
        {loadingPsychologists ? (
          ...
          <div className="card-elevated rounded-2xl p-8 text-center">
            <BadgeCheck className="mx-auto w-10 h-10 text-muted-foreground" />

            <h3 className="mt-4 font-heading font-semibold">
              Ainda não há profissionais publicados
            </h3>

            <p className="mt-2 text-sm text-muted-foreground">
              Em breve você poderá encontrar psicólogos verificados por aqui.
            </p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 pb-24">
        <div className="rounded-3xl p-8 lg:p-12 text-center relative overflow-hidden">
          ...
          <h2 className="mt-5 text-2xl sm:text-3xl font-heading font-bold text-white">
            Privacidade pensada desde o primeiro acesso
          </h2>

          <p className="mt-3 text-white/85 max-w-2xl mx-auto">
            Sabemos quais dados coletamos, por quê, e como os protegemos. Você
            no controle do seu consentimento.
          </p>

          <Link
            to="/privacidade"
            className="mt-7 inline-flex items-center gap-2 px-6 py-3 rounded-full bg-white text-primary font-semibold hover:scale-[1.02] transition-transform"
          >
            Conhecer nossa central de privacidade
            <ArrowRight size={17} />
          </Link>
        </div>
      </section>
